...
trainingDigits =r'E:\大学文件\machinelearning\KNN_Distinguish-master\KNN手写数字识别\digits\trainingDigits'#绝对路径
testDigits = r'E:\大学文件\machinelearning\KNN_Distinguish-master\KNN手写数字识别\digits\testDigits'
...
def shibie():
    ...
    print("准确率 %.2f%%" % ((1 - (errornum / float(testnum))) * 100))
